            ...
            <x-filament::section>
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-danger-600 dark:text-danger-400">Subscription Expired</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                Your subscription has expired. Please choose a plan below to continue using the service.
                            </p>
                        </div>
                    </div>
                </div>
